...
import './AddFacultyDevelopmentProgram.css';

const AddFacultyDevelopmentProgram = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch('http://localhost:5000/api/faculty/me/update', {
      ...
      body: JSON.stringify({
        field: 'facultyDevelopmentPrograms',
        data: dataToSend,
      }),
    });
  ...
  return (
    <div className="add-fdp-container">
      <button className="back-button" onClick={() => navigate('/faculty-dashboard')}>
        &larr; Back to Dashboard
      </button>
      <h1>Add Faculty Development Program</h1>
      <p>Fill in the details for your faculty development program entry.</p>

      <form className="fdp-form" onSubmit={handleSubmit}>
        <fieldset>
          <legend>Entry Details</legend>
          <p>Please provide accurate information for your faculty development program record.</p>
...
export default AddFacultyDevelopmentProgram;
