...
const FacultyLogin = ({ onLogin, theme }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://faculty-information-and-activity-c1b1.onrender.com/api/auth/faculty-login', {
        method: 'POST',
    ...
    <div className={`login-container ${theme === 'dark' ? 'dark-theme' : ''}`}>
      <div className="login-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="button" className="btn-google" onClick={() => window.location.href = 'https://faculty-information-and-activity-c1b1.onrender.com/api/auth/google/faculty'}>
