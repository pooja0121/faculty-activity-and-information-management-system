...
const AddFellowship = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert('Fellowship entry saved successfully');
        navigate('/faculty-dashboard');
      } else {
        alert('Failed to save fellowship entry');
      }
    } catch (error) {
      alert('Error saving fellowship entry');
    }
  };
