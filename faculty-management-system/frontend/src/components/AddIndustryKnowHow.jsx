...
import './AddIndustryKnowHow.css';

const AddIndustryKnowHow = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert('Industry Know How entry saved successfully');
        navigate('/faculty-dashboard');
      } else {
        alert('Failed to save Industry Know How entry');
      }
    } catch (error) {
      alert('Error saving Industry Know How entry');
    }
  };
  ...
  return (
    <div className="add-industry-know-how-container">
      <button className="back-button" onClick={handleCancel}>← Back to Dashboard</button>
      <h1>Add Industry Know How</h1>
      <p>Fill in the details for your industry know how entry.</p>
...
export default AddIndustryKnowHow;
